...
| [`graph`](graph.md)                   | Build, view, and export Stencila graphs                              |
...
| [`db`](db/index.md)                   | Manage the workspace database                                        |
| [`workflows`](workflows/index.md)     | Manage workflow definitions                                          |
| [`agents`](agents/index.md)           | Manage agent definitions                                             |
| [`skills`](skills/index.md)           | Manage agent skills                                                  |
...
| [`mcp`](mcp/index.md)                 | Manage MCP (Model Context Protocol) servers                          |
| [`tools`](tools/index.md)             | Manage tools and environments used by Stencila                       |
| [`secrets`](secrets/index.md)         | Manage secrets                                                       |
| [`auth`](auth/index.md)               | Manage OAuth authentication for AI model providers                   |
| [`credentials`](credentials/index.md) | Manage and inspect Stencila C2PA Content Credentials                 |
