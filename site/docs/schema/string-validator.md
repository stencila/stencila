...
| `minLength` | The minimum length for a string node.               | [`Integer`](./integer.md) | -                       | `stencila:minLength`                 | `min-length`, `min_length` |
| `maxLength` | The maximum length for a string node.               | [`Integer`](./integer.md) | -                       | `stencila:maxLength`                 | `max-length`, `max_length` |
| `pattern`   | A regular expression that a string node must match. | [`String`](./string.md)   | -                       | `stencila:pattern`                   | -                          |
