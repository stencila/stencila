...
| `rows`    | The number of rows of data.     | [`Integer`](./integer.md)                            | -                       | `stencila:rows`                      | -        |
| `columns` | A hint for each column of data. | [`DatatableColumnHint`](./datatable-column-hint.md)* | -                       | `stencila:columns`                   | `column` |
