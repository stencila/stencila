...
| `value` | The time of day as a string in format `hh:mm:ss[Z\|(+\|-)hh:mm]`. | [`String`](./string.md) | -                       | [`schema:value`](https://schema.org/value) | -       |
...
| [JATS](../formats/jats.md)                       | 🟢 No loss    | 🟢 No loss    | Encoded as [`<time>`](https://jats.nlm.nih.gov/articleauthoring/tag-library/1.3/element/time.html) using special function |
