...
| `source`    | A `Reference` to the `CreativeWork` that the excerpt was taken from. | [`Reference`](./reference.md) | -                       | `stencila:source`                    | -                          |
| `nodePath`  | The path to the node that was excepted.                              | [`String`](./string.md)       | -                       | `stencila:nodePath`                  | `node-path`, `node_path`   |
| `nodeTypes` | The types of the ancestor nodes and the node that was excerpted.     | [`String`](./string.md)       | -                       | `stencila:nodeTypes`                 | `node-types`, `node_types` |
| `content`   | The excerpted content.                                               | [`Block`](./block.md)*        | -                       | `stencila:content`                   | -                          |
