...
| `content`             | The content within the styled block                                    | [`Block`](./block.md)*                            | -                       | `stencila:content`                           | -                                                                                                                  |
...
| [HTML](../formats/html.md)                       | 🟢 No loss    |              | Encoded as [`<div>`](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/div) |
