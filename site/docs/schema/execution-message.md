...
| `level`        | The severity level of the message.                                   | [`MessageLevel`](./message-level.md) | -                       | `stencila:level`                     | -                                     |
| `message`      | The text of the message.                                             | [`String`](./string.md)              | -                       | `stencila:message`                   | -                                     |
| `errorType`    | The type of error e.g. "SyntaxError", "ZeroDivisionError".           | [`String`](./string.md)              | -                       | `stencila:errorType`                 | `error-type`, `error_type`            |
| `codeLocation` | The location that the error occurred or other message emanated from. | [`CodeLocation`](./code-location.md) | -                       | `stencila:codeLocation`              | `code-location`, `code_location`      |
| `stackTrace`   | Stack trace leading up to the error.                                 | [`String`](./string.md)              | -                       | `stencila:stackTrace`                | `trace`, `stack-trace`, `stack_trace` |
