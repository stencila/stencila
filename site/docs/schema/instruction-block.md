...
| `content`               | The content to which the instruction applies.                              | [`Block`](./block.md)*                              | -                                 | `stencila:content`                   | -                                                                                                                         |
| `suggestions`           | Suggestions for the instruction                                            | [`SuggestionBlock`](./suggestion-block.md)*         | -                                 | `stencila:suggestions`               | `suggestion`                                                                                                              |
