...
| `isAutomatic`        | Whether the island is automatically generated.     | [`Boolean`](./boolean.md)      | -                       | `stencila:isAutomatic`               | `is-automatic`, `is_automatic`               |
| `labelType`          | The type of the label for the island.              | [`LabelType`](./label-type.md) | -                       | `stencila:labelType`                 | `label-type`, `label_type`                   |
...
| `style`              | The style to apply to the island.                  | [`String`](./string.md)        | -                       | `stencila:style`                     | -                                            |
