---
title: Request
description: A request for research work, evidence, protocol execution, or another contribution.
---

This is a block-level research request node.

It is used for authored requests that can be related to questions, claims,
...
The `Request` type is related to these types:
...
The `Request` type is represented in:

- [JSON-LD](https://stencila.org/Request.jsonld)
- [JSON Schema](https://stencila.org/Request.schema.json)
- Python class [`Request`](https://github.com/stencila/stencila/blob/main/python/stencila_types/src/stencila_types/types.py)
- Rust struct [`Request`](https://github.com/stencila/stencila/blob/main/rust/schema/src/types/request.rs)
- TypeScript class [`Request`](https://github.com/stencila/stencila/blob/main/ts/src/types/Request.ts)

# Testing

During property-based (a.k.a generative) testing, the properties of the `Request` type are generated using the following strategies.
...
This documentation was generated from [`Request.yaml`](https://github.com/stencila/stencila/blob/main/schema/Request.yaml) by [`docs_types.rs`](https://github.com/stencila/stencila/blob/main/rust/schema-gen/src/docs_types.rs).
