...
| `pageStart`      | The page on which the volume starts; for example "135" or "xiii".                                                       | [`Integer`](./integer.md) \| [`String`](./string.md)                              | -                                    | [`schema:pageStart`](https://schema.org/pageStart)           | `page-start`, `page_start`                                                                |
| `pageEnd`        | The page on which the volume ends; for example "138" or "xvi".                                                          | [`Integer`](./integer.md) \| [`String`](./string.md)                              | -                                    | [`schema:pageEnd`](https://schema.org/pageEnd)               | `page-end`, `page_end`                                                                    |
