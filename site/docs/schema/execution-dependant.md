...
| `dependantRelation` | The relation to the dependant.              | [`ExecutionDependantRelation`](./execution-dependant-relation.md) | -                       | `stencila:dependantRelation`         | `dependant-relation`, `dependant_relation` |
| `dependantType`     | The type of node that is the dependant.     | [`String`](./string.md)                                           | -                       | `stencila:dependantType`             | `dependant-type`, `dependant_type`         |
| `dependantId`       | The id of node that is the dependant.       | [`String`](./string.md)                                           | -                       | `stencila:dependantId`               | `dependant-id`, `dependant_id`             |
| `codeLocation`      | The location that the dependant is defined. | [`CodeLocation`](./code-location.md)                              | -                       | `stencila:codeLocation`              | `code-location`, `code_location`           |
