...
| `value`    | The time difference in `timeUnit`s.        | [`Integer`](./integer.md)    | -                       | [`schema:value`](https://schema.org/value) | -                        |
...
| [JATS](../formats/jats.md)                       | 🟢 No loss    | 🟢 No loss    | Encoded as [`<duration>`](https://jats.nlm.nih.gov/articleauthoring/tag-library/1.3/element/duration.html) using special function |
