...
| `timeUnits` | The time units that the duration can have. | [`TimeUnit`](./time-unit.md)* | -                       | `stencila:timeUnits`                 | `time-units`, `time_units`, `timeUnit`, `time-unit`, `time_unit` |
| `minimum`   | The inclusive lower limit for a duration.  | [`Duration`](./duration.md)   | -                       | `stencila:minimum`                   | -                                                                |
| `maximum`   | The inclusive upper limit for a duration.  | [`Duration`](./duration.md)   | -                       | `stencila:maximum`                   | -                                                                |
