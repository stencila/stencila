---
title: Question
description: A question or research prompt.
---

This is a block-level implementation of schema.org `Question`, adapted for
research documents and discourse graphs.

It is used for explicit research questions that authors may want to identify,
cite, relate to claims and evidence, or export to graph-oriented interchange
formats. Like `Claim`, it carries structured block content so authors can use
normal document markup inside the question.
...
The `Question` type has these properties:

| Name             | Description                                                                                                             | Type                                                                              | Inherited from                           |
| ---------------- | ----------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------- | ---------------------------------------- |
| `label`          | A short label for the research object.                                                                                  | [`String`](./string.md)                                                           | [`ResearchObject`](./research-object.md) |
| `content`        | Content of the research object.                                                                                         | [`Block`](./block.md)*                                                            | [`ResearchObject`](./research-object.md) |
| `relations`      | Relations from this research object to other research objects.                                                          | [`ResearchObjectRelation`](./research-object-relation.md)*                        | [`ResearchObject`](./research-object.md) |
| `extra`          | Additional metadata for the research object.                                                                            | [`Object`](./object.md)                                                           | [`ResearchObject`](./research-object.md) |
...
The `Question` type is related to these types:

- Parents: [`ResearchObject`](./research-object.md)
- Children: none

# Bindings

The `Question` type is represented in:

- [JSON-LD](https://stencila.org/Question.jsonld)
- [JSON Schema](https://stencila.org/Question.schema.json)
- Python class [`Question`](https://github.com/stencila/stencila/blob/main/python/stencila_types/src/stencila_types/types.py)
- Rust struct [`Question`](https://github.com/stencila/stencila/blob/main/rust/schema/src/types/question.rs)
- TypeScript class [`Question`](https://github.com/stencila/stencila/blob/main/ts/src/types/Question.ts)

# Testing

During property-based (a.k.a generative) testing, the properties of the `Question` type are generated using the following strategies.
...
This documentation was generated from [`Question.yaml`](https://github.com/stencila/stencila/blob/main/schema/Question.yaml) by [`docs_types.rs`](https://github.com/stencila/stencila/blob/main/rust/schema-gen/src/docs_types.rs).
