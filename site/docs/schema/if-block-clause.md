...
| `isActive`              | Whether this clause is the active clause in the parent `IfBlock` node | [`Boolean`](./boolean.md)                           | -                                        | `stencila:isActive`                                                    | `is-active`, `is_active`                                                                                                  |
| `content`               | The content to render if the result is truthy                         | [`Block`](./block.md)*                              | -                                        | `stencila:content`                                                     | -                                                                                                                         |
