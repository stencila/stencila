...
| `length`    | The length (number of items) of the array. | [`Integer`](./integer.md)     | -                       | `stencila:length`                    | -                                                                |
| `itemTypes` | The distinct types of the array items.     | [`String`](./string.md)*      | -                       | `stencila:itemTypes`                 | `item-types`, `item_types`, `itemType`, `item-type`, `item_type` |
| `minimum`   | The minimum value in the array.            | [`Primitive`](./primitive.md) | -                       | `stencila:minimum`                   | -                                                                |
| `maximum`   | The maximum value in the array.            | [`Primitive`](./primitive.md) | -                       | `stencila:maximum`                   | -                                                                |
| `nulls`     | The number of `Null` values in the array.  | [`Integer`](./integer.md)     | -                       | `stencila:nulls`                     | -                                                                |
