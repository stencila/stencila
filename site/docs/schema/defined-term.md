...
| `termCode`       | A code that identifies this DefinedTerm within a DefinedTermSet | [`String`](./string.md)                                              | -                       | [`schema:termCode`](https://schema.org/termCode)           | `term-code`, `term_code`                                                                  |
