...
| [HTML](../formats/html.md)                       | 🟢 No loss    |              | Encoded as [`<q>`](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/q)                                    |
| [JATS](../formats/jats.md)                       | 🟢 No loss    | 🟢 No loss    | Encoded as [`<inline-quote>`](https://jats.nlm.nih.gov/articleauthoring/tag-library/1.3/element/inline-quote.html) |
| [Markdown](../formats/md.md)                     | ⚠️ High loss |              | Encoded as `<q>{{content}}</q>`                                                                                    |
