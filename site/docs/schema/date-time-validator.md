...
| `minimum` | The inclusive lower limit for a date-time. | [`DateTime`](./date-time.md) | -                       | `stencila:minimum`                   | -       |
| `maximum` | The inclusive upper limit for a date-time. | [`DateTime`](./date-time.md) | -                       | `stencila:maximum`                   | -       |
