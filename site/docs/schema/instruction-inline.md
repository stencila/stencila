...
| `instructionType`       | The type of instruction describing the operation to be performed.          | [`InstructionType`](./instruction-type.md)          | [`Instruction`](./instruction.md) | `stencila:instructionType`           | `instruction-type`, `instruction_type`                                                                                    |
| `prompt`                | The prompt selected, rendered and provided to the model                    | [`PromptBlock`](./prompt-block.md)                  | [`Instruction`](./instruction.md) | `stencila:prompt`                    | -                                                                                                                         |
| `message`               | The instruction message, possibly including images, audio, or other media. | [`InstructionMessage`](./instruction-message.md)    | [`Instruction`](./instruction.md) | `stencila:message`                   | -                                                                                                                         |
| `modelParameters`       | Model selection and inference parameters.                                  | [`ModelParameters`](./model-parameters.md)          | [`Instruction`](./instruction.md) | `stencila:modelParameters`           | `model-parameters`, `model_parameters`, `model-params`, `model_params`, `model-pars`, `model_pars`, `model`               |
| `activeSuggestion`      | The index of the suggestion that is currently active                       | [`UnsignedInteger`](./unsigned-integer.md)          | [`Instruction`](./instruction.md) | `stencila:activeSuggestion`          | `active-suggestion`, `active_suggestion`                                                                                  |
| `content`               | The content to which the instruction applies.                              | [`Inline`](./inline.md)*                            | -                                 | `stencila:content`                   | -                                                                                                                         |
| `suggestions`           | Suggestions for the instruction                                            | [`SuggestionInline`](./suggestion-inline.md)*       | -                                 | `stencila:suggestions`               | `suggestion`                                                                                                              |
