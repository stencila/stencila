...
| `itemsNullable`  | Whether items can have the value `Node::Null`                                               | [`Boolean`](./boolean.md)     | -                       | `stencila:itemsNullable`             | `items-nullable`, `items_nullable`   |
| `itemsValidator` | Another validator node specifying the constraints on all items in the array.                | [`Validator`](./validator.md) | -                       | `stencila:itemsValidator`            | `items-validator`, `items_validator` |
| `contains`       | An array node is valid if at least one of its items is valid against the `contains` schema. | [`Validator`](./validator.md) | -                       | `stencila:contains`                  | -                                    |
| `minItems`       | An array node is valid if its size is greater than, or equal to, this value.                | [`Integer`](./integer.md)     | -                       | `stencila:minItems`                  | `min-items`, `min_items`             |
| `maxItems`       | An array node is valid if its size is less than, or equal to, this value.                   | [`Integer`](./integer.md)     | -                       | `stencila:maxItems`                  | `max-items`, `max_items`             |
| `uniqueItems`    | A flag to indicate that each value in the array should be unique.                           | [`Boolean`](./boolean.md)     | -                       | `stencila:uniqueItems`               | `unique-items`, `unique_items`       |
