---
title: Protocol
description: A research protocol or method description.
---

This is a block-level research protocol node.

It is used for authored protocols, methods, or planned procedures that can be
identified, cited, related to claims or evidence, and exported to
...
The `Protocol` type is related to these types:
...
The `Protocol` type is represented in:

- [JSON-LD](https://stencila.org/Protocol.jsonld)
- [JSON Schema](https://stencila.org/Protocol.schema.json)
- Python class [`Protocol`](https://github.com/stencila/stencila/blob/main/python/stencila_types/src/stencila_types/types.py)
- Rust struct [`Protocol`](https://github.com/stencila/stencila/blob/main/rust/schema/src/types/protocol.rs)
- TypeScript class [`Protocol`](https://github.com/stencila/stencila/blob/main/ts/src/types/Protocol.ts)

# Testing

During property-based (a.k.a generative) testing, the properties of the `Protocol` type are generated using the following strategies.
...
This documentation was generated from [`Protocol.yaml`](https://github.com/stencila/stencila/blob/main/schema/Protocol.yaml) by [`docs_types.rs`](https://github.com/stencila/stencila/blob/main/rust/schema-gen/src/docs_types.rs).
