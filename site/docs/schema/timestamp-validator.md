...
| `timeUnits` | The time units that the timestamp can have. | [`TimeUnit`](./time-unit.md)* | -                       | `stencila:timeUnits`                 | `time-units`, `time_units`, `timeUnit`, `time-unit`, `time_unit` |
| `minimum`   | The inclusive lower limit for a timestamp.  | [`Timestamp`](./timestamp.md) | -                       | `stencila:minimum`                   | -                                                                |
| `maximum`   | The inclusive upper limit for a timestamp.  | [`Timestamp`](./timestamp.md) | -                       | `stencila:maximum`                   | -                                                                |
