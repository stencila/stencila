...
| `name`       | The name of the function.        | [`String`](./string.md)        | -                       | [`schema:name`](https://schema.org/name) | -           |
| `parameters` | The parameters of the function.  | [`Parameter`](./parameter.md)* | -                       | `stencila:parameters`                    | `parameter` |
| `returns`    | The return type of the function. | [`Validator`](./validator.md)  | -                       | `stencila:returns`                       | -           |
