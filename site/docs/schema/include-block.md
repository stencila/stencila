...
| `source`                | The external source of the content, a file path or URL.          | [`String`](./string.md)                             | -                               | `stencila:source`                                            | -                                                                                                                         |
...
| `select`                | A query to select a subset of content from the source            | [`String`](./string.md)                             | -                               | `stencila:select`                                            | -                                                                                                                         |
| `content`               | The structured content decoded from the source.                  | [`Block`](./block.md)*                              | -                               | `stencila:content`                                           | -                                                                                                                         |
