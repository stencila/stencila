...
| `content`        | Content of the comment, usually one or more paragraphs.                                                                 | [`Block`](./block.md)*                                                            | -                                    | `stencila:content`                                           | -                                                                                         |
| `parentItem`     | The parent comment of this comment.                                                                                     | [`Comment`](./comment.md)                                                         | -                                    | [`schema:parentItem`](https://schema.org/parentItem)         | `parent-item`, `parent_item`                                                              |
| `commentAspect`  | The part or facet of the item that is being commented on.                                                               | [`String`](./string.md)                                                           | -                                    | `stencila:commentAspect`                                     | `comment-aspect`, `comment_aspect`                                                        |
