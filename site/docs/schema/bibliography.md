...
| `source`                | The external source of the bibliography, a file path or URL.     | [`String`](./string.md)                             | -                               | `stencila:source`                                            | -                                                                                                                         |
| `mediaType`             | Media type of the source content.                                | [`String`](./string.md)                             | -                               | [`schema:encodingFormat`](https://schema.org/encodingFormat) | `encodingFormat`, `media-type`, `media_type`                                                                              |
| `references`            | The references loaded from the source.                           | [`Reference`](./reference.md)*                      | -                               | `stencila:references`                                        | `reference`                                                                                                               |
...
The `Bibliography` type can be encoded (serialized) to, and/or decoded (deserialized) from, these formats:
