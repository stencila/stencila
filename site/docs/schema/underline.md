...
| [HTML](../formats/html.md)                       | 🟢 No loss    |              | Encoded as [`<u>`](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/u)                              |
| [JATS](../formats/jats.md)                       | 🟢 No loss    | 🟢 No loss    | Encoded as [`<underline>`](https://jats.nlm.nih.gov/articleauthoring/tag-library/1.3/element/underline.html) |
| [Markdown](../formats/md.md)                     | 🟢 No loss    | 🟢 No loss    | Encoded as `<u>{{content}}</u>`                                                                              |
