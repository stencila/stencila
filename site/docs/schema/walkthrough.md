...
| `isCollapsed` | Whether the walkthrough is collapsed | [`Boolean`](./boolean.md)                   | -                       | `stencila:isCollapsed`               | `is-collapsed`, `is_collapsed` |
| `steps`       | The steps making up the walkthrough. | [`WalkthroughStep`](./walkthrough-step.md)* | -                       | `stencila:steps`                     | `step`                         |
