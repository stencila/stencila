...
| `dateStart`      | The date this Periodical was first published.                                                                           | [`Date`](./date.md)                                                               | -                                    | [`schema:startDate`](https://schema.org/startDate)           | `date-start`, `date_start`                                                                |
| `dateEnd`        | The date this Periodical ceased publication.                                                                            | [`Date`](./date.md)                                                               | -                                    | [`schema:endDate`](https://schema.org/endDate)               | `date-end`, `date_end`                                                                    |
| `issns`          | The International Standard Serial Number(s) (ISSN) that identifies this serial publication.                             | [`String`](./string.md)*                                                          | -                                    | [`schema:issn`](https://schema.org/issn)                     | `issn`                                                                                    |
