...
- Children: [`ActionStatusType`](./action-status-type.md), [`AdmonitionType`](./admonition-type.md), [`AuthorRoleName`](./author-role-name.md), [`CitationIntent`](./citation-intent.md), [`CitationMode`](./citation-mode.md), [`ClaimType`](./claim-type.md), [`CreativeWorkType`](./creative-work-type.md), [`ExecutionBounds`](./execution-bounds.md), [`ExecutionMode`](./execution-mode.md), [`ExecutionRequired`](./execution-required.md), [`ExecutionStatus`](./execution-status.md), [`FormDeriveAction`](./form-derive-action.md), [`GraphEdgeKind`](./graph-edge-kind.md), [`GraphEvidenceConfidence`](./graph-evidence-confidence.md), [`GraphEvidenceKind`](./graph-evidence-kind.md), [`HorizontalAlignment`](./horizontal-alignment.md), [`InstructionType`](./instruction-type.md), [`LabelType`](./label-type.md), [`ListOrder`](./list-order.md), [`MessageLevel`](./message-level.md), [`MessageRole`](./message-role.md), [`NoteType`](./note-type.md), [`ProvenanceCategory`](./provenance-category.md), [`RelativePosition`](./relative-position.md), [`ResearchObjectRelationKind`](./research-object-relation-kind.md), [`SectionType`](./section-type.md), [`SuggestionStatus`](./suggestion-status.md), [`SuggestionType`](./suggestion-type.md), [`TableCellType`](./table-cell-type.md), [`TableRowType`](./table-row-type.md), [`TimeUnit`](./time-unit.md), [`VerticalAlignment`](./vertical-alignment.md), [`WorktreeStatus`](./worktree-status.md)
