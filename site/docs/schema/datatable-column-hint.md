...
| `itemType` | The type of items in the column.           | [`String`](./string.md)       | -                       | `stencila:itemType`                  | `item-type`, `item_type` |
| `minimum`  | The minimum value in the column.           | [`Primitive`](./primitive.md) | -                       | `stencila:minimum`                   | -                        |
| `maximum`  | The maximum value in the column.           | [`Primitive`](./primitive.md) | -                       | `stencila:maximum`                   | -                        |
| `nulls`    | The number of `Null` values in the column. | [`Integer`](./integer.md)     | -                       | `stencila:nulls`                     | -                        |
