...
| `name`                  | The name of the parameter.                                                                             | [`String`](./string.md)                             | -                               | [`schema:name`](https://schema.org/name)                 | -                                                                                                                         |
| `label`                 | A short label for the parameter.                                                                       | [`String`](./string.md)                             | -                               | `stencila:label`                                         | -                                                                                                                         |
| `value`                 | The current value of the parameter.                                                                    | [`Node`](./node.md)                                 | -                               | [`schema:value`](https://schema.org/value)               | -                                                                                                                         |
| `default`               | The default value of the parameter.                                                                    | [`Node`](./node.md)                                 | -                               | [`schema:defaultValue`](https://schema.org/defaultValue) | -                                                                                                                         |
| `validator`             | The validator that the value is validated against.                                                     | [`Validator`](./validator.md)                       | -                               | `stencila:validator`                                     | -                                                                                                                         |
| `derivedFrom`           | The dotted path to the object (e.g. a database table column) that the parameter should be derived from | [`String`](./string.md)                             | -                               | `stencila:derivedFrom`                                   | `derived-from`, `derived_from`                                                                                            |
...
| [JATS](../formats/jats.md)                       |              |              | Encoded as [`<parameter>`](https://jats.nlm.nih.gov/articleauthoring/tag-library/1.3/element/parameter.html) |
