...
| -------- | -------------------------- | --------------------------------------------------- | -------------- | ------------- | ------- |
| `ghost`  | Ghost publishing options.  | [`ConfigPublishGhost`](./config-publish-ghost.md)   | -              | ``            | -       |
| `zenodo` | Zenodo publishing options. | [`ConfigPublishZenodo`](./config-publish-zenodo.md) | -              | ``            | -       |
