...
| `isCollapsed` | Whether this step is active (i.e. is encoded in source format and can be edited) | [`Boolean`](./boolean.md) | -                       | `stencila:isCollapsed`               | `is-collapsed`, `is_collapsed` |
| `content`     | The content of the step.                                                         | [`Block`](./block.md)*    | -                       | `stencila:content`                   | -                              |
