...
| `length` | The number of entries in the object.         | [`Integer`](./integer.md) | -                       | `stencila:length`                    | -       |
| `keys`   | The keys of the object's entries.            | [`String`](./string.md)*  | -                       | `stencila:keys`                      | `key`   |
| `values` | Hints to the values of the object's entries. | [`Hint`](./hint.md)*      | -                       | `stencila:values`                    | `value` |
