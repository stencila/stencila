...
| `dateCreated`    | Date/time of creation.                                                                                                  | [`DateTime`](./date-time.md)                                                      | -                       |
| `dateReceived`   | Date/time that work was received.                                                                                       | [`DateTime`](./date-time.md)                                                      | -                       |
| `dateAccepted`   | Date/time of acceptance.                                                                                                | [`DateTime`](./date-time.md)                                                      | -                       |
| `dateModified`   | Date/time of most recent modification.                                                                                  | [`DateTime`](./date-time.md)                                                      | -                       |
| `datePublished`  | Date of first publication.                                                                                              | [`DateTime`](./date-time.md)                                                      | -                       |
