...
| `jatsRefType`         | The value of the `ref-type` attribute when the link originated as a JATS cross-reference.                           | [`String`](./string.md)                           | -                       |
| `jatsExtLinkType`     | The value of the `ext-link-type` attribute when the link originated as a JATS external link.                        | [`String`](./string.md)                           | -                       |
