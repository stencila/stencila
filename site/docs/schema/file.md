...
| `name`             | The name of the file.                                                                                                   | [`String`](./string.md)                                                           | -                                    | [`schema:name`](https://schema.org/name)                     | -                                                                                         |
...
| `mediaType`        | IANA media type (MIME type).                                                                                            | [`String`](./string.md)                                                           | -                                    | [`schema:encodingFormat`](https://schema.org/encodingFormat) | `encodingFormat`, `media-type`, `media_type`                                              |
| `transferEncoding` | The encoding used for the context (e.g. base64, gz)                                                                     | [`String`](./string.md)                                                           | -                                    | `stencila:transferEncoding`                                  | `transfer-encoding`, `transfer_encoding`                                                  |
| `size`             | The size of the content in bytes                                                                                        | [`UnsignedInteger`](./unsigned-integer.md)                                        | -                                    | [`schema:size`](https://schema.org/size)                     | -                                                                                         |
| `content`          | The content of the file.                                                                                                | [`String`](./string.md)                                                           | -                                    | [`schema:content`](https://schema.org/content)               | -                                                                                         |
