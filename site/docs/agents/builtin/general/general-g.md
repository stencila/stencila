...
A general-purpose agent using Google's frontier model

**Keywords:** general · assistant · unspecialized · broad · default · fallback

> [!tip] Usage
>
> To use this agent, start your prompt with `#general-g` in the Stencila TUI, or select it with the `/agent` command. You can also reference it by name in a workflow pipeline.
...
- when a generally useful default agent is needed for one-shot assistance across mixed topics using Google's frontier model
...
This page was generated from [`.stencila/agents/general-g/AGENT.md`](https://github.com/stencila/stencila/blob/main/.stencila/agents/general-g/AGENT.md).
