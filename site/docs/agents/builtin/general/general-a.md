...
A general-purpose agent using Anthropic's frontier model
...
- when a generally useful default agent is needed for one-shot assistance across mixed topics using Anthropic's frontier model
...
This page was generated from [`.stencila/agents/general-a/AGENT.md`](https://github.com/stencila/stencila/blob/main/.stencila/agents/general-a/AGENT.md).
