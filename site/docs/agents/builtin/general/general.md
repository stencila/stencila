...
A general-purpose agent using the default model provider

**Keywords:** general · assistant · unspecialized · broad · default · fallback

> [!tip] Usage
>
> To use this agent, start your prompt with `#general` in the Stencila TUI, or select it with the `/agent` command. You can also reference it by name in a workflow pipeline.
...
This page was generated from [`.stencila/agents/general/AGENT.md`](https://github.com/stencila/stencila/blob/main/.stencila/agents/general/AGENT.md).
