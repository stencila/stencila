...
> [!tip] Usage
>
> To use this agent, start your prompt with `#general-m` in the Stencila TUI, or select it with the `/agent` command. You can also reference it by name in a workflow pipeline.
