import { isA, CodeChunk, CodeExpression, Parameter } from '@stencila/schema'
...
const getNodeById = (id: string) => document.getElementById(id)

export const updateNode = (id: string) => (node: UpdatableNode) => {
