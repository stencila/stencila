...
export default class StencilaIcon extends StencilaElement {
  ...
  render() {
    return html`<sl-icon
      src=${getIconSrc(this.name, this.fallback)}
      label=${this.label}
    ></sl-icon>`
  }
}
 ...
 */
export function getIconSrc(name: IconName, fallback: IconName): string {
  let svg = icons[name]
...
const icons: Record<string, string> = {
  ...
  'button-centered': '<svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" preserveAspectRatio="xMidYMid meet" viewBox="0 0 32 32"><path fill="currentColor" d="M9 15h14v2H9z"/><path fill="currentColor" d="M28 22H4a2.002 2.002 0 0 1-2-2v-8a2.002 2.002 0 0 1 2-2h24a2.002 2.002 0 0 1 2 2v8a2.002 2.002 0 0 1-2 2ZM4 12v8h24v-8Z"/></svg>',
  ...
  'http': globe,
  'postgrest': `<svg width="234.66667" height="346.66666" viewBox="0 0 234.66667 346.66666">
      <path style="fill:currentColor;stroke:currentColor;stroke-width:12;stroke-linecap:butt;stroke-linejoin:miter;stroke-miterlimit:4;stroke-dasharray:none;stroke-opacity:1" d="m 74.293039,9.8904846 c -27.55907,18.5182364 43.639281,51.9177854 22.178,89.2064024 -10.98855,21.833143 -29.72997,45.586233 -41.12061,59.115683 30.5933,32.79034 34.94724,37.35908 48.254251,50.11355 -53.945381,7.32866 -45.880701,46.94585 -29.726661,72.43779 18.16217,23.92661 28.724471,33.58305 51.638741,52.16526 10.91516,-15.40732 9.04305,-15.21883 16.21655,-25.2445 -13.35302,-9.84022 -35.93373,-29.57306 -25.90005,-39.81259 13.89565,-16.39355 36.65093,-5.49998 55.39582,1.90549 9.05158,-11.20917 5.12625,-7.39878 15.88829,-19.0257 -38.36385,-30.00498 -58.76596,-62.4508 -47.60127,-88.48154 10.30689,-27.09997 35.16672,-51.5716 35.16672,-51.5716 C 106.63559,40.563487 96.836209,0.27696558 74.293039,9.8904846 Z" id="path358" />
    </svg>`,
  'postgrest-color': `<svg width="234.66667" height="346.66666" viewBox="0 0 234.66667 346.66666">
                          <path style="fill:#2c6a99;fill-opacity:1;stroke:#000000;stroke-width:12;stroke-linecap:butt;stroke-linejoin:miter;stroke-miterlimit:4;stroke-dasharray:none;stroke-opacity:1" d="m 74.293039,9.8904846 c -27.55907,18.5182364 43.639281,51.9177854 22.178,89.2064024 -10.98855,21.833143 -29.72997,45.586233 -41.12061,59.115683 30.5933,32.79034 34.94724,37.35908 48.254251,50.11355 -53.945381,7.32866 -45.880701,46.94585 -29.726661,72.43779 18.16217,23.92661 28.724471,33.58305 51.638741,52.16526 10.91516,-15.40732 9.04305,-15.21883 16.21655,-25.2445 -13.35302,-9.84022 -35.93373,-29.57306 -25.90005,-39.81259 13.89565,-16.39355 36.65093,-5.49998 55.39582,1.90549 9.05158,-11.20917 5.12625,-7.39878 15.88829,-19.0257 -38.36385,-30.00498 -58.76596,-62.4508 -47.60127,-88.48154 10.30689,-27.09997 35.16672,-51.5716 35.16672,-51.5716 C 106.63559,40.563487 96.836209,0.27696558 74.293039,9.8904846 Z" id="path358" />
                      </svg>`,
  ...
  'sql': '<svg viewBox="0 0 24 24" width="24" height="24"><path fill="none" d="M0 0h24v24H0z"/><path fill="currentColor" d="M5 12.5c0 .313.461.858 1.53 1.393C7.914 14.585 9.877 15 12 15c2.123 0 4.086-.415 5.47-1.107 1.069-.535 1.53-1.08 1.53-1.393v-2.171C17.35 11.349 14.827 12 12 12s-5.35-.652-7-1.671V12.5zm14 2.829C17.35 16.349 14.827 17 12 17s-5.35-.652-7-1.671V17.5c0 .313.461.858 1.53 1.393C7.914 19.585 9.877 20 12 20c2.123 0 4.086-.415 5.47-1.107 1.069-.535 1.53-1.08 1.53-1.393v-2.171zM3 17.5v-10C3 5.015 7.03 3 12 3s9 2.015 9 4.5v10c0 2.485-4.03 4.5-9 4.5s-9-2.015-9-4.5zm9-7.5c2.123 0 4.086-.415 5.47-1.107C18.539 8.358 19 7.813 19 7.5c0-.313-.461-.858-1.53-1.393C16.086 5.415 14.123 5 12 5c-2.123 0-4.086.415-5.47 1.107C5.461 6.642 5 7.187 5 7.5c0 .313.461.858 1.53 1.393C7.914 9.585 9.877 10 12 10z"/></svg>',
  ...
  'tailwind': '<svg viewBox="0 0 128 128"><path d="M64.004 25.602c-17.067 0-27.73 8.53-32 25.597 6.398-8.531 13.867-11.73 22.398-9.597 4.871 1.214 8.352 4.746 12.207 8.66C72.883 56.629 80.145 64 96.004 64c17.066 0 27.73-8.531 32-25.602-6.399 8.536-13.867 11.735-22.399 9.602-4.87-1.215-8.347-4.746-12.207-8.66-6.27-6.367-13.53-13.738-29.394-13.738zM32.004 64c-17.066 0-27.73 8.531-32 25.602C6.402 81.066 13.87 77.867 22.402 80c4.871 1.215 8.352 4.746 12.207 8.66 6.274 6.367 13.536 13.738 29.395 13.738 17.066 0 27.73-8.53 32-25.597-6.399 8.531-13.867 11.73-22.399 9.597-4.87-1.214-8.347-4.746-12.207-8.66C55.128 71.371 47.868 64 32.004 64zm0 0" fill="currentColor"></path></svg>',
