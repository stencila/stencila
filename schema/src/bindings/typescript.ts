...
type Primitives = undefined | null | boolean | number | string | Array<unknown> | ObjectType
 ...
 */
export const titleToType = (title: string | number): string => {
  switch (title) {
    case 'Null':
      return 'null'
    case 'Boolean':
...
const schemaToType = (schema: JsonSchema): string => {
  ...
  if (type === 'object') return 'ObjectType'
