...
Citation <- function(
  ...
  self$type <- as_scalar("Citation")
  self[["pageEnd"]] <- check_property("Citation", "pageEnd", FALSE, missing(pageEnd), Union("character", "numeric"), pageEnd)
  self[["pageStart"]] <- check_property("Citation", "pageStart", FALSE, missing(pageStart), Union("character", "numeric"), pageStart)
  self[["pagination"]] <- check_property("Citation", "pagination", FALSE, missing(pagination), "character", pagination)
  class(self) <- c(class(self), "Entity")
  self
}
