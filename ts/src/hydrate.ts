...
export function hydrate(value: types.Node): types.Node {
  ...
  switch (value.type) {
    ...
    case "Boundary":
      return Object.setPrototypeOf(value, types.Boundary.prototype);
    case "Brand":
    ...
    case "Icon":
      return Object.setPrototypeOf(value, types.Icon.prototype);
    case "IfBlock":
    ...
    case "Page":
      return Object.setPrototypeOf(value, types.Page.prototype);
    case "Paragraph":
