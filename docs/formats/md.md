...
| [Bibliography](https://stencila.ghost.io/docs/reference/schema/bibliography)                 | ⚠️ High loss |            |                                    |
...
| [Collection](https://stencila.ghost.io/docs/reference/schema/collection)                     | ⚠️ High loss |            | Encoded using implemented function |
...
| [Reference](https://stencila.ghost.io/docs/reference/schema/reference)                       | ⚠️ High loss |            | Encoded using implemented function |
...
| [Supplement](https://stencila.ghost.io/docs/reference/schema/supplement)                     | ⚠️ High loss |            | Encoded using implemented function |
...
| **Style**                                                                                    |
| [Page](https://stencila.ghost.io/docs/reference/schema/page)                                 | ⚠️ High loss |            | Encoded using implemented function |
