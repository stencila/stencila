...
Stencila provides a support for DOCX as way to collaborate with colleagues using word processors and to integrate with workflows and tools using DOCX.
...
| [Bibliography](https://stencila.ghost.io/docs/reference/schema/bibliography)                 | 🔷 Low loss | 🔷 Low loss |       |
