...
By default, the encoded JSON is indented. However, the `--compact` option is supported which produces un-indented, single line JSON.
...
| [InstructBlock](https://github.com/stencila/stencila/blob/main/docs/reference/schema/edits/instruct_block.md)             | 🟢 No loss    | 🟢 No loss    |       |
| [InstructInline](https://github.com/stencila/stencila/blob/main/docs/reference/schema/edits/instruct_inline.md)           | 🟢 No loss    | 🟢 No loss    |       |
