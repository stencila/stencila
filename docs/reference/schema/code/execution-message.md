...
| `level`        | -                                     | `stencila:level`                     | [`ExecutionMessageLevel`](https://github.com/stencila/stencila/blob/main/docs/reference/schema/flow/execution-message-level.md) | The text of the message.                                             | -                                                                                                |
