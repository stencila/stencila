...
| pageEnd        | [schema:pageEnd](https://schema.org/pageEnd)                          | integer _or_ string                                                                                  | The page on which the volume ends; for example "138" or "xvi".                                                          | [PublicationVolume](PublicationVolume.md) |
| pageStart      | [schema:pageStart](https://schema.org/pageStart)                      | integer _or_ string                                                                                  | The page on which the volume starts; for example "135" or "xiii".                                                       | [PublicationVolume](PublicationVolume.md) |
| pagination     | [schema:pagination](https://schema.org/pagination)                    | string                                                                                               | Any description of pages that is not separated into pageStart and pageEnd; for example, "1-6, 9, 55".                   | [PublicationVolume](PublicationVolume.md) |
...
| volumeNumber   | [schema:volumeNumber](https://schema.org/volumeNumber)                | integer _or_ string                                                                                  | Identifies the volume of publication or multi-part work; for example, "iii" or "2".                                     | [PublicationVolume](PublicationVolume.md) |
...
- [JSON-LD](https://schema.stenci.la/PublicationVolume.jsonld)
- [JSON Schema](https://schema.stenci.la/v1/PublicationVolume.schema.json)
- Python [`class PublicationVolume`](https://stencila.github.io/schema/python/docs/types.html#schema.types.PublicationVolume)
- TypeScript [`interface PublicationVolume`](https://stencila.github.io/schema/ts/docs/interfaces/publicationvolume.html)
- R [`class PublicationVolume`](https://cran.r-project.org/web/packages/stencilaschema/stencilaschema.pdf)
- Rust [`struct PublicationVolume`](https://docs.rs/stencila-schema/latest/stencila_schema/struct.PublicationVolume.html)
