...
| values | `stencila:values`                    | [`Node`](https://github.com/stencila/stencila/blob/main/docs/reference/schema/other/node.md)*   | A node is valid if it is equal to any of these values. | -                                                                                                |
