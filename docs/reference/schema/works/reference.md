...
| `isPartOf`   | An other `CreativeWork` that the reference is a part of.                                              | [`CreativeWorkVariant`](https://stencila.ghost.io/docs/reference/schema/creative-work-variant)                                             | -                                                                  | [`schema:isPartOf`](https://schema.org/isPartOf)     | `is-part-of`, `is_part_of` |
