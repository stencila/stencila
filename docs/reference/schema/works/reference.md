...
| `appearanceIndex` | The index (1-based) of appearance order of the reference in the work.                                 | [`UnsignedInteger`](https://stencila.ghost.io/docs/reference/schema/unsigned-integer)                                                                      | -                                                                  | `stencila:appearanceIndex`                               | `appearance-index`, `appearance_index` |
