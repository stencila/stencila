...
| `source`                | The external source of the bibliography, a file path or URL.     | [`String`](https://stencila.ghost.io/docs/reference/schema/string)                             | -                                                                          | `stencila:source`                                            | -                                                                                                                         |
...
| `references`            | The references loaded from the source.                           | [`Reference`](https://stencila.ghost.io/docs/reference/schema/reference)*                      | -                                                                          | `stencila:references`                                        | `reference`                                                                                                               |
