...
| `clauses`               | `clause`                                                                                                                  | `stencila:clauses`                   | [`IfBlockClause`](https://github.com/stencila/stencila/blob/main/docs/reference/schema/flow/if-block-clause.md)*            | The clauses making up the `If` node                                  | -                                                                                                       |
...
- [JSON-LD](https://stencila.dev/IfBlock.jsonld)
- [JSON Schema](https://stencila.dev/IfBlock.schema.json)
