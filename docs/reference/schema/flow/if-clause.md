...
| isActive              | `stencila:isActive`                                                    | [`Boolean`](https://github.com/stencila/stencila/blob/main/docs/reference/schema/data/boolean.md)                           | Whether this clause is the active clause in the parent `If` node     | -                                                                                                                |
