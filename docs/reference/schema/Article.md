...
This is an implementation, and extension, of schema.org [`Article`](https://schema.org/Article). It extends schema.org `Article` by, adding a `content` property which must be an array of [`BlockContent`](./BlockContent), as well as the properties added by [`CreativeWork`](./CreativeWork) which it extends. An `Article` is analogous, and structurally similar to, the JATS XML [`<article>`](https://jats.nlm.nih.gov/articleauthoring/tag-library/1.2/element/article.html) element.
...
| content        | [stencila:content](https://schema.stenci.la/content.jsonld)           | Array of [BlockContent](BlockContent.md)                                                             | The structured content of this article. See note [2](#notes).                                                           | [Article](Article.md)           |
...
| pageEnd        | [schema:pageEnd](https://schema.org/pageEnd)                          | integer _or_ string                                                                                  | The page on which the article ends; for example "138" or "xvi".                                                         | [Article](Article.md)           |
| pageStart      | [schema:pageStart](https://schema.org/pageStart)                      | integer _or_ string                                                                                  | The page on which the article starts; for example "135" or "xiii".                                                      | [Article](Article.md)           |
...
2. **content** : This is an override of `CreativeWork.content` to restrict node to `BlockContent` node types e.g `Paragraph`.
...
- [JSON-LD](https://schema.stenci.la/Article.jsonld)
- [JSON Schema](https://schema.stenci.la/v1/Article.schema.json)
- Python [`class Article`](https://stencila.github.io/schema/python/docs/types.html#schema.types.Article)
- TypeScript [`interface Article`](https://stencila.github.io/schema/ts/docs/interfaces/article.html)
- R [`class Article`](https://cran.r-project.org/web/packages/stencilaschema/stencilaschema.pdf)
- Rust [`struct Article`](https://docs.rs/stencila-schema/latest/stencila_schema/struct.Article.html)
