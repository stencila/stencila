...
The `Config` type is represented in these bindings:
...
This documentation was generated from [`Config.yaml`](https://github.com/stencila/stencila/blob/main/schema/Config.yaml) by [`docs_type.rs`](https://github.com/stencila/stencila/blob/main/rust/schema-gen/src/docs_type.rs).
