...
- [`ExecutionBounds`](https://github.com/stencila/stencila/blob/main/docs/reference/schema/flow/execution-bounds.md)
...
- [`InstructionType`](https://github.com/stencila/stencila/blob/main/docs/reference/schema/works/instruction-type.md)
...
- [`MessageRole`](https://github.com/stencila/stencila/blob/main/docs/reference/schema/other/message-role.md)
...
- [`RelativePosition`](https://github.com/stencila/stencila/blob/main/docs/reference/schema/other/relative-position.md)
