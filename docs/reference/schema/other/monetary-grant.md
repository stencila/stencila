...
| `fundedItems`    | Indicates an item funded or sponsored through a Grant.                                                   | [`Thing`](https://stencila.ghost.io/docs/reference/schema/thing)*                                                                                          | [`Grant`](https://stencila.ghost.io/docs/reference/schema/grant)   | [`schema:fundedItem`](https://schema.org/fundedItem)       | `funded-items`, `funded_items`, `fundedItem`, `funded-item`, `funded_item`                |
