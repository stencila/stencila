...
| `maximumRetries` | `retries`, `maximum-retries`, `maximum_retries`                                | `stencila:retries`                   | [`UnsignedInteger`](https://github.com/stencila/stencila/blob/main/docs/reference/schema/data/unsigned-integer.md) | The maximum number of retries.                          | -                                                                                                |
