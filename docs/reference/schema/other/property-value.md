...
| propertyID     | [`schema:propertyID`](https://schema.org/propertyID)       | [`String`](https://github.com/stencila/stencila/blob/main/docs/reference/schema/data/string.md)                                                                                                                      | A commonly used identifier for the characteristic represented by the property. | -                                                                                                |
