...
| [JATS](https://github.com/stencila/stencila/blob/main/docs/reference/formats/jats.md)         | 🟢 No loss      |              | 🚧 Under development    | Encoded to tag [`<sub>`](https://jats.nlm.nih.gov/articleauthoring/tag-library/1.3/element/sub) |
