...
| `labelOnly`           | Only show the label of the internal target (e.g. "2"), rather than both the label type and label (e.g. "Figure 2"). | [`Boolean`](https://stencila.ghost.io/docs/reference/schema/boolean)                         | -                                                                  | `stencila:labelOnly`                                             | `label-only`, `label_only`                                                                                         |
| `compilationMessages` | Messages generated while compiling the link (e.g. missing internal link or invalid external link).                  | [`CompilationMessage`](https://stencila.ghost.io/docs/reference/schema/compilation-message)* | -                                                                  | `stencila:compilationMessages`                                   | `compilation-messages`, `compilation_messages`, `compilationMessage`, `compilation-message`, `compilation_message` |
...
| [HTML](https://stencila.ghost.io/docs/reference/formats/html)                       | 🟢 No loss    |              | Encoded as [`<a>`](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/a)                            |
