...
| [JATS](https://github.com/stencila/stencila/blob/main/docs/reference/formats/JATS.md)             | 🔷 Low loss     |              | 🚧 Under development    | Encoded to tag [`<strike>`](https://jats.nlm.nih.gov/articleauthoring/tag-library/1.3/element/strike) |
| [Markdown](https://github.com/stencila/stencila/blob/main/docs/reference/formats/Markdown.md)     | 🟥 High loss    |              | 🚧 Under development    | Encoded using template `~~{content}~~`                                                                |
