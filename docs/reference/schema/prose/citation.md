...
| `content`             | A rendering of the citation using the citation style of the document.                                 | [`Inline`](https://stencila.ghost.io/docs/reference/schema/inline)*                                                                        | -                                                                  | `stencila:content`                                   | -                                                                                                                  |
