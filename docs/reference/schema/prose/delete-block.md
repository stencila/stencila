...
| -------------------------------------------------------------------------------------------------- | ---------------- | ------------ | ---------------------- | ----------------------------------------------------------------------------------------------------------------------- |
| [HTML](https://github.com/stencila/stencila/blob/main/docs/reference/formats/html.md)              | 🔷 Low loss       |              | 🚧 Under development    | Encoded as [`<stencila-delete-block>`](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/stencila-delete-block) |
...
- [JSON-LD](https://stencila.dev/DeleteBlock.jsonld)
- [JSON Schema](https://stencila.dev/DeleteBlock.schema.json)
