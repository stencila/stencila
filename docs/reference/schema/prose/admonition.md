...
| `isFolded`       | `is-folded`, `is_folded`             | `stencila:title`                     | [`Boolean`](https://github.com/stencila/stencila/blob/main/docs/reference/schema/data/boolean.md)                 | Whether the admonition is folded. | -                                                                                                |
...
| [JATS](https://github.com/stencila/stencila/blob/main/docs/reference/formats/jats.md)         |                  | 🟢 No loss    | 🚧 Under development    | Encoded as [`<boxed-text>`](https://jats.nlm.nih.gov/articleauthoring/tag-library/1.3/element/boxed-text.html) |
| [Markdown](https://github.com/stencila/stencila/blob/main/docs/reference/formats/markdown.md) | ⚠️ High loss     | 🟢 No loss    | 🚧 Under development    | Encoded using special function                                                                                 |
...
- [JSON-LD](https://stencila.dev/Admonition.jsonld)
- [JSON Schema](https://stencila.dev/Admonition.schema.json)
