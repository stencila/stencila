...
| `prompt`                | -                                                                                                                         | `stencila:prompt`                    | [`PromptBlock`](https://github.com/stencila/stencila/blob/main/docs/reference/schema/edits/prompt-block.md)                 | The prompt selected, rendered and provided to the model                    | [`Instruction`](https://github.com/stencila/stencila/blob/main/docs/reference/schema/edits/instruction.md) |
...
| `modelParameters`       | `model-parameters`, `model_parameters`, `model-params`, `model_params`, `model-pars`, `model_pars`, `model`               | `stencila:modelParameters`           | [`ModelParameters`](https://github.com/stencila/stencila/blob/main/docs/reference/schema/other/model-parameters.md)         | Model selection and inference parameters.                                  | [`Instruction`](https://github.com/stencila/stencila/blob/main/docs/reference/schema/edits/instruction.md) |
