...
This documentation was generated from [`ModifyOperation.yaml`](https://github.com/stencila/stencila/blob/main/schema/ModifyOperation.yaml) by [`docs.rs`](https://github.com/stencila/stencila/blob/main/rust/schema-gen/src/docs.rs).