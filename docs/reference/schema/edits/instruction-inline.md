...
| `provenance`            | -                                                                                                                         | `stencila:provenance`                        | [`ProvenanceCount`](https://github.com/stencila/stencila/blob/main/docs/reference/schema/other/provenance-count.md)*           | A summary of the provenance of the messages and content within the instruction. | [`Instruction`](https://github.com/stencila/stencila/blob/main/docs/reference/schema/edits/instruction.md) |
...
| `suggestion`            | -                                                                                                                         | `stencila:suggestion`                        | [`SuggestionInlineType`](https://github.com/stencila/stencila/blob/main/docs/reference/schema/edits/suggestion-inline-type.md) | A suggestion for the instruction                                                | -                                                                                                          |
