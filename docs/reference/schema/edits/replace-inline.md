...
This documentation was generated from [`ReplaceInline.yaml`](https://github.com/stencila/stencila/blob/main/schema/ReplaceInline.yaml) by [`docs.rs`](https://github.com/stencila/stencila/blob/main/rust/schema-gen/src/docs.rs).
