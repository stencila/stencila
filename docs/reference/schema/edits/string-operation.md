...
This documentation was generated from [`StringOperation.yaml`](https://github.com/stencila/stencila/blob/main/schema/StringOperation.yaml) by [`docs.rs`](https://github.com/stencila/stencila/blob/main/rust/schema-gen/src/docs.rs).