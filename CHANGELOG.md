...
* **Images:** Verify manifest digest and use in annotations ([2cb3673](https://github.com/stencila/stencila/commit/2cb3673fbddb106b5dd066c10d098a9d68b00fcc))
...
* **Images:** Add `--manifest-format` option ([1e5fa85](https://github.com/stencila/stencila/commit/1e5fa85c5ebfa457b8910568dede6c14d3fbded2))
...
## [1.11.1](https://github.com/stencila/stencila/compare/v1.11.0...v1.11.1) (2022-06-13)

# [1.11.0](https://github.com/stencila/stencila/compare/v1.10.0...v1.11.0) (2022-06-12)
...
* **dependencies:** update docusaurus monorepo to v2.0.0-beta.17 ([81f4deb](https://github.com/stencila/stencila/commit/81f4debdc169df5ef0afb64596e77c5f9c0e71f2))
...
* **Python:** Major refactoring and fixes for CNB and local builds ([1e56ef7](https://github.com/stencila/stencila/commit/1e56ef7fd89d7249bab4bd50c0ff459ee70539fb))
...
* **CSL codec:** First iteration of codec for CSL JSON ([879308a](https://github.com/stencila/stencila/commit/879308a59726b33dccb24f5d15b6ce7d79fdcdae))
...
* **Python binary:** Do not require `asdf` to get list of binaries ([a251feb](https://github.com/stencila/stencila/commit/a251febc58a74fc24c87949ac514d1737516d8f7))
...
* **Thing:** Add images property ([45eeba0](https://github.com/stencila/stencila/commit/45eeba0bb94cb00c14a89e5d2e0f789d744ed35c))
* **Type Guards:** Add isInstanceOf guard for matching descendant types ([9985936](https://github.com/stencila/stencila/commit/9985936cdd588c30c4ae856f24b019ba6262db56)), closes [#135](https://github.com/stencila/stencila/issues/135)
* **Type Guards:** Allow typeGuards to work on undefined nodes ([35a9ba7](https://github.com/stencila/stencila/commit/35a9ba72c84a87b4cc7294b9dacb5e19f08faabd))
* **TypeGuards:** Port type guards from Encoda to Schema project ([cb0c050](https://github.com/stencila/stencila/commit/cb0c050161412b732a36023acbfc4385e19e12a0))
* **Typescript factory functions:** Only first required prop is unnamed ([02b3483](https://github.com/stencila/stencila/commit/02b34831cb2634fab63a91a8ec86fbd11a3efc78))
* **Typescript:** Add a more convienient single-type type guard ([0e59220](https://github.com/stencila/stencila/commit/0e59220598d3c047daef59a2f53e84f31b7cb8bd))
* **Typescript:** Add isType type guard ([ed8fb4a](https://github.com/stencila/stencila/commit/ed8fb4af76eab15ba9d737a729d066e2c0b73fde))
* **Typescript:** Adds factory functions for Typescript ([39d0fc6](https://github.com/stencila/stencila/commit/39d0fc62a757c6d1e3caacfc6d3cbaa7eae850b9)), closes [#84](https://github.com/stencila/stencila/issues/84)
* **UnixSocketClient/Server.py:** add Python Unix domain socket client/server ([d15a45c](https://github.com/stencila/stencila/commit/d15a45cb049709c2964d5ef72fd21a9776cd2d26))
* **Util:** Add markTypes TypeMap ([1552d06](https://github.com/stencila/stencila/commit/1552d0683e72934c8f0bb2ac6ff321c321041f89))
* **Util:** Add Typescript utility functions for inspecting JSON Schemas at runtime ([d5475f9](https://github.com/stencila/stencila/commit/d5475f9407b75b5f9b3f8447e3d8a9fee085f492))
* **Util:** Add version and URL utility functions ([274dd52](https://github.com/stencila/stencila/commit/274dd52e0a7361517e28d17f335c1ed5cab7b6a6))
* **VSCode bindings:** Add maapings between file types and schemas ([2544b6e](https://github.com/stencila/stencila/commit/2544b6ea755239cef67cbaaf236a92ebcce1f6c6))


### Performance Improvements

* **Rust:** Do not include meta property ([893de26](https://github.com/stencila/stencila/commit/893de2697a9a505783312d09dd7f4d1a62af470e))
* **Rust:** Reduce memory footprint of type deserialization discriminant ([7c36200](https://github.com/stencila/stencila/commit/7c3620054089918ea9ad0b2c2dbdd643a30c7487))
* **Rust:** Use simple structs for creative works when present as inline or block content ([9a650d1](https://github.com/stencila/stencila/commit/9a650d13206c0f8d0abba7b0995cebabbc606b0a))


### Reverts

* Revert "ci(R): Switch to R 3.6" ([d2c5724](https://github.com/stencila/stencila/commit/d2c57242df1333fb28fa39ccc6d6cdb70cb154bc))
...
* **Binary crate:** Re-add dep and fixup feature flags ([b4b6961](https://github.com/stencila/stencila/commit/b4b6961d34dc67dccf56ff52fad19fc49cd5886b))
* **Calc kernel:** Handle conversion of integers ([5a704f0](https://github.com/stencila/stencila/commit/5a704f020b865f168b888899b2108b37586c2d11))
* **CLI:** Allow `display` option to override custom display format ([00cb4e2](https://github.com/stencila/stencila/commit/00cb4e27262bc963ccfaf76dd617681c16e14dc7))
* **Codec:** Use `create` instead of `open` when encoding to a path ([03c7eb1](https://github.com/stencila/stencila/commit/03c7eb1f54deea4bdbdffa1fc72e40c3d04ff8b9))
* **Dependency graph:** Only use content digest is semantic digest is empty ([5e054ff](https://github.com/stencila/stencila/commit/5e054fff1ba2b21da98370fe5f2211f8e36ec75b))
* **Dependency graphs:** Ensure resources with no relations are added to the graph ([b9c9c1a](https://github.com/stencila/stencila/commit/b9c9c1ae8e4d0787860c4e47cb0d1ecc066381be))
* **Formats:** Add variants for `Date` and `Person` text representations ([1a6f0fe](https://github.com/stencila/stencila/commit/1a6f0fecd9efbb713313c5a14c75a0a7bf77066e))
* **Graph resources:** Use forward slashes for `File` resources for consistency across platforms ([b25ddf4](https://github.com/stencila/stencila/commit/b25ddf4c54ba5eb639a342d934c6b9d6d703d03f))
* **Graph resources:** Use forward slashes for other resources too ([744e1c0](https://github.com/stencila/stencila/commit/744e1c061846d6ab2337400a19ec5e512b1df2ca))
* **Graphs:** Place line number in parentheses for GraphViz format ([084c531](https://github.com/stencila/stencila/commit/084c5316ba3091d5b610100e1f5f3c6a40e7f0c1))
* **Kernels:** Do not include newlines in code of task table ([3c6a193](https://github.com/stencila/stencila/commit/3c6a193bac4de559f77a71171bbea7e7ba07699e))
* **Kernels:** Improve kernel selection and make `back` and `fork` normal options ([4aa378f](https://github.com/stencila/stencila/commit/4aa378f9a383e9fc9d0d2a6b6ca9698a34c3e8d9))
* **Kernels:** Remove unecessary `is_async` argument ([43f52d6](https://github.com/stencila/stencila/commit/43f52d6a2f06d73676f01e446c4ca48a87e2cb74))
* **Microkernels:** Execute asynchronously even if kernel is not interruptable ([0a0e4b4](https://github.com/stencila/stencila/commit/0a0e4b4080564d1138d84b37823b7fcb550c50f1))
* **Node bindings:** Correct module name ([fec9925](https://github.com/stencila/stencila/commit/fec9925598a0ccd4531c0fba1f9315eb937a6cd6))
* **Node bindings:** Fix access to project graph ([3c5f8ce](https://github.com/stencila/stencila/commit/3c5f8ce3d2647408e572f0ad2976d061d0985425))
* **Node compilation:** Keep track of the last programming language of code nodes ([e695719](https://github.com/stencila/stencila/commit/e6957197986b7dd60caa4691e6812b8f410e14fd))
* **Node compilation:** Use shorter, more semantic but still unique (to document) node ids ([2083cad](https://github.com/stencila/stencila/commit/2083cad0644ae8236456560fc31317c2db0f9017))
* **Node patches:** Only replace atomics if not equal ([a5ee690](https://github.com/stencila/stencila/commit/a5ee69021bc3e8e255ec5eb257db93fc2fb37d3d))
* **Node patches:** Replace atomic node types with node types ([b83b537](https://github.com/stencila/stencila/commit/b83b537239ee8a3751697e5bd682fc4ba6cfcfc2))
* **Pandoc codec:** Updates for changes in `formats` and `binaries` ([079ca14](https://github.com/stencila/stencila/commit/079ca145643907d9dfb9c71caa72451591e8577e))
* **Parser:** Add `[@alters](https://github.com/alters)` tag ([c94129a](https://github.com/stencila/stencila/commit/c94129a43a3adebad21244b1bdc6860f7f7d7e09))
* **Parsers:** Fix regex to detect tags with no arguments e.g. `[@pure](https://github.com/pure)` ([4f8aa9e](https://github.com/stencila/stencila/commit/4f8aa9e51135b4c9a1715988b3af8be9a1f8cd9e))
* **Parsers:** Pass on other parse info ([b4e6988](https://github.com/stencila/stencila/commit/b4e698882b4a6e53179671e0408f389c310976b8))
* **Parsers:** Remove carriage returns from code ([9538b46](https://github.com/stencila/stencila/commit/9538b466cf517bd7548532a715059f63a14c953b))
* **R microkernel:** Don't try to install `parallel` package ([cad434d](https://github.com/stencila/stencila/commit/cad434d36bd95b2311273779f1edcff0f958beaf))
* **R microkernel:** Handle interrupts more gracefully ([e4a7782](https://github.com/stencila/stencila/commit/e4a778238803f9ddcbcc039174cede44bc8c44a0))
* **R microkernel:** Quote JSON properly on `set`; `unbox` on `get` ([1d68294](https://github.com/stencila/stencila/commit/1d68294a98484783505ed73addd309bcd240a997))
* **Rust:** Upgrade `schema` ([f74d850](https://github.com/stencila/stencila/commit/f74d850a2fa41230a470ca979972551a8902d81a))
* **UUIDs:** Add `PartialOrd` and `Ord` traits to allow sorting and searching ([80372bc](https://github.com/stencila/stencila/commit/80372bc54a105566fe3571af748a002d706ed0ec))
* **Web patches:** Apply patches for changes in `programmingLanguage` ([a69b4c9](https://github.com/stencila/stencila/commit/a69b4c9be56f618f7e0730019d1bfbb479bbf5ed))
* **Web patches:** Upgrade `schema` and add support for new executable code properties ([e3e9c76](https://github.com/stencila/stencila/commit/e3e9c76ffb12ca0502a29de2ebda3829bf381b3c))


### Features

* **Binaries:** Add `require_any` function to allow for alternatives ([cf95675](https://github.com/stencila/stencila/commit/cf95675d8377e122fc53ff1e7caa99ca556ebfe9))
* **CLI:** Add `--as` as an alias to `--display` ([817f047](https://github.com/stencila/stencila/commit/817f0478ced821426c7a87ed3d659468d7333e5e))
* **Dependency graph:** Add `update` function ([3ca0f50](https://github.com/stencila/stencila/commit/3ca0f5075b30f5cdb195880d2c1f16eaf9f49548))
* **Dependency graphs:** Store `ResourceInfo`s for each node ([1927c9c](https://github.com/stencila/stencila/commit/1927c9cbbde00f29f68c9d7b767665665c3750f0))
* **Documents:** Create dependency graph for documents ([1ff7278](https://github.com/stencila/stencila/commit/1ff7278167a14b293dce0f2f6073ab10acb12e87))
* **Documents:** Integrate execution planner  for executing documents ([e2a6588](https://github.com/stencila/stencila/commit/e2a65881d60d804449b2ce78294b1ad971cc1cb4))
* **Documents:** Make kernel and task inspection commands available for a document ([9ce04bf](https://github.com/stencila/stencila/commit/9ce04bf2106ac4848ab216058db1af7700692dea))
* **Events:** Add interrupt event topic ([d809da6](https://github.com/stencila/stencila/commit/d809da67afd822be6df73578d23811a51ad9ebb5))
* **Formats:** Add `normalize_title` function ([4c8e7fb](https://github.com/stencila/stencila/commit/4c8e7fba68bbb92879ab1ec88a151dbddea489f8))
* **Graph:** Add topological sorting ([8695e5b](https://github.com/stencila/stencila/commit/8695e5bb829034179ebaa9c36f87651334a98d2b))
* **HTML encoding:** Add support for new executable code properties ([2f0ae62](https://github.com/stencila/stencila/commit/2f0ae6200e21bb2aeec863c4c5f5a9e6fd6c0846))
* **Kernels:** Add `cancel_all` function ([5ef24fd](https://github.com/stencila/stencila/commit/5ef24fdc9762ebb3e6b323287c9496afea58beb1))
* **Kernels:** Add `forkable` to `Kernel` specification ([fd6e50b](https://github.com/stencila/stencila/commit/fd6e50baf2b867f7e40982dc53d824de70ffb9dd))
* **Kernels:** Add duration column in tasks display ([7f4eb0b](https://github.com/stencila/stencila/commit/7f4eb0b55679d52212c7dbf2042378de42cf9e96))
* **Kernels:** Cancel foreground tasks using `Ctrl-C` ([99d6214](https://github.com/stencila/stencila/commit/99d621424d34e86fe8bb627184bde3ca8f79b42c))
* **Kernels:** Clean up tasks ([fb0c051](https://github.com/stencila/stencila/commit/fb0c051ea03b933dead4b0bbd487348101b04978))
* **Kernels:** Display table of tasks ([032b50c](https://github.com/stencila/stencila/commit/032b50ccda57866d0d17dd2328c50633e1af9550))
* **Kernels:** Improved displays for `symbols`, and `queues` commands; move `cancel` ([7d466cc](https://github.com/stencila/stencila/commit/7d466ccab826a3e84d58872828d5f73af65b9680))
* **Node execution:** Add execution planning ([0cb081d](https://github.com/stencila/stencila/commit/0cb081daf6febb9efb2c4a772eeb034fb779fabf))
* **Node execution:** Add step concurrency for `Appearance` strategy ([f87588b](https://github.com/stencila/stencila/commit/f87588baa5bc678cde338842932e49d400dc3a2e))
* **Node execution:** Initial iteration of plan execution ([d3af771](https://github.com/stencila/stencila/commit/d3af7718e3ee79cb4571898c26316627e1183aad))
* **Node execution:** Match code nodes with kernels ([ebc574d](https://github.com/stencila/stencila/commit/ebc574d87a404902e8ad35e09f24ff83c4260d71))
* **Node execution:** Record code hashes and re-execute dependencies if needed ([690fd14](https://github.com/stencila/stencila/commit/690fd14390db7f34eb7b35cfcf17969c0ab17d9a))
* **Node execution:** Update execution related properties on code nodes ([7bbf032](https://github.com/stencila/stencila/commit/7bbf0326dd9e4589ed3b769e5a304e270bc64f3d))
* **Node patches:** Apply a patch with an `address` or `target` ([d6f48fd](https://github.com/stencila/stencila/commit/d6f48fd1fd104706c267399d84ffc8b5861792e2))
* **Parsers:** Add `code_hash` and `semantic_hash` properties ([6ab2abe](https://github.com/stencila/stencila/commit/6ab2abe25dcc9016f144cb4df2dabc26ff1aaf7d))
* **Parsers:** Allow code to be supplied as text on command line ([e5743ae](https://github.com/stencila/stencila/commit/e5743ae1008991ac840de6f3749237d7bd5eceb3))
* **Parsers:** Handle `[@pure](https://github.com/pure)` and `[@impure](https://github.com/impure)` tags in comments ([45bd823](https://github.com/stencila/stencila/commit/45bd8236a5bf06a64288f92d4b92756ddf35eb96))
* **Patches:** Add support for new executable code properties; make `value_html` return an option ([736c15a](https://github.com/stencila/stencila/commit/736c15abb4de16bd63adc8736e5175173eb52cd7))
...
* **Bash microkernel:** Use `printf` ([bd0882b](https://github.com/stencila/stencila/commit/bd0882b88e916ced7d78cac136f10d9c5ab616d3))
* **Binaries:** Allow `require` for any binary; rename `list` command to `installable` ([55b1500](https://github.com/stencila/stencila/commit/55b150080e564b17b78fdf45bb817264afcb6636))
* **Binaries:** Always match on lowercase name ([1b181ad](https://github.com/stencila/stencila/commit/1b181ad66ce3226917613da974515dab952c8ab9))
* **Binaries:** Search for name or aliases of registered binaries ([0934732](https://github.com/stencila/stencila/commit/09347327f5f6c9e3b64165ee49edcd8d3e855548))
* **Binaries:** Use correct crate name ([8cc3590](https://github.com/stencila/stencila/commit/8cc359010149c22ce8d6d30ab3054a411d7f2080))
* **Binary:** Move `installations` back to trait so overrides of version are used ([d89b305](https://github.com/stencila/stencila/commit/d89b305f69961ebeaa62d2290ca36b6459c952aa))
* **Chrome binary:** Get version on Windows ([81afa41](https://github.com/stencila/stencila/commit/81afa41b26891fdea071be762c958c3ca7b73801))
* **Deno microkernel:** FIx semver requirement ([c30940c](https://github.com/stencila/stencila/commit/c30940c22c68aa21108f178169545cc902e06b65))
* **Jupyter kernel:** Add Jupyter  to log and error messages to clarify ([7b49e6b](https://github.com/stencila/stencila/commit/7b49e6b7d1ab6de956dfb508b12533d7a030ef7c))
* **Kernels REPL:** Default to getting symbol ([7c6af0b](https://github.com/stencila/stencila/commit/7c6af0b6158105b1d4e6154203a7f99d2acbc2ef))
* **Kernels:** Allow selector tags to have hyphens ([7b447c9](https://github.com/stencila/stencila/commit/7b447c973bf80935da2aaf1a5dd3a3de63ce66c6))
* **Kernels:** Fix escape sequences in old versions of Bash ([6cb0f6d](https://github.com/stencila/stencila/commit/6cb0f6d1f0bb47143cae9bee15cd1f74cdc96ba6))
* **Kernels:** Fix handling of paths with whitespaces on mac ([a34b241](https://github.com/stencila/stencila/commit/a34b24106836a6614e24b46244e882f5cadea64d))
* **Kernels:** When searching for running kernels also check against name ([1fde46c](https://github.com/stencila/stencila/commit/1fde46cc0ddb190924d6e714924729e63e9a4c4f))
* **Microkernels:** Add `READY` flag to protocol ([7ec3af1](https://github.com/stencila/stencila/commit/7ec3af1e47ea0b17d14eec0fb279f9cf5af8bff8)), closes [#1329](https://github.com/stencila/stencila/issues/1329)
* **Microkernels:** Add features for `binaries` crate ([1690ea8](https://github.com/stencila/stencila/commit/1690ea8c8228e781adfaecad5a950740c1157b86))
* **Microkernels:** Add lines other than those with `READY` flag ([ecd950d](https://github.com/stencila/stencila/commit/ecd950d4f016e48de3f346539b79d6ee8f6b8762))
* **Microkernels:** Allow compile on Windows where `nix` crate is not functional ([8c0e79d](https://github.com/stencila/stencila/commit/8c0e79d32fd69b92929f4b14a2c6d9e9cb1dc686))
* **Microkernels:** Allow for escaping of Unicode on Windows ([cb346d3](https://github.com/stencila/stencila/commit/cb346d3d4c083163775025b8ec5124b389ee3631))
* **Microkernels:** Update status of pipe failures ([a9a6854](https://github.com/stencila/stencila/commit/a9a6854d7b6af95476e93f2c32fb39334ee0b6bc))
* **Node kernel:** Fix line unescaping, override console methods ([9967d38](https://github.com/stencila/stencila/commit/9967d38f839e08bc3bde9b95c1f019cd6991b03f))
* **Pandoc binary:** Move Windows path to globs ([e55af70](https://github.com/stencila/stencila/commit/e55af7005c5da2ce444e52d96a13617a7c2b3de9))
* **Patches:** Replace, rather than diff,  Base64 `content_url`s of `MediaObject` types ([88bd9ca](https://github.com/stencila/stencila/commit/88bd9caba3c68c529c02b2aa2048a54ca968ef4e))
* **Python kernel:** Monkey patch `print` for multiple outputs; encode values and errors ([52d6d50](https://github.com/stencila/stencila/commit/52d6d50d803ac1c41f6b510ebed21379b86b7bf4))
* **R kernel:** Do not output from assignment on last line ([c716289](https://github.com/stencila/stencila/commit/c716289c14a502212a9184c63de5c34c29fc1d5f))
* **R kernel:** Error handling and encoding / decoding of values ([0c78b0a](https://github.com/stencila/stencila/commit/0c78b0a29b56eca7d9f21408a58ebbcba68e2812))
* **R microkernel:** Capture plots and avoid recursive print calls ([cfb5a42](https://github.com/stencila/stencila/commit/cfb5a427b5d87886bb663629709e42b013f38017))
* **R microkernel:** Handle the creation of user library ([cc4ccf8](https://github.com/stencila/stencila/commit/cc4ccf89894f565c69ed24b9093b0c2990a2cab0))
* **R microkernel:** Set `.libPaths` and ensure `requires()` is truely quiet ([80c2281](https://github.com/stencila/stencila/commit/80c22819c288c5f0987e2af900037964f92ea5b2))
* **R microkernel:** Suppress messages on install ([ca46d8a](https://github.com/stencila/stencila/commit/ca46d8a6683429b6ae9718f47a6ea4e9d0f17855))
* **R microkernel:** Suppress warnings when requiring ([d847313](https://github.com/stencila/stencila/commit/d847313944046332f0b52971114c859935bd0aa8))
* **R microkernel:** Unbox string outputs ([d8760ce](https://github.com/stencila/stencila/commit/d8760cee22dda5e6e711e5a4a7e5665cca57e9d7))
* **Rscript binary:** Update crate name ([3f41131](https://github.com/stencila/stencila/commit/3f4113168739f38d7cb0af98ea8d4a624c5a6be8))
* **Rscript binary:** Use correct casing ([47da877](https://github.com/stencila/stencila/commit/47da877935c642294dc2a63f1ed89dbeec9fabef))
* **Store kernel:** Update `get` to be `mut` ([0b1febd](https://github.com/stencila/stencila/commit/0b1febd37855cdb318f25e8aa381822ffcc071cd))
* **Web client:** Respect attribute aliases for `Add` operations ([5523797](https://github.com/stencila/stencila/commit/5523797641d45b3d4439ac106e42ef97bffdc2d0))


### Features

* **Bash microkernel:** Initial iteration of a ([c516aee](https://github.com/stencila/stencila/commit/c516aee9cc0573473086a1725fa50573985e201b))
* **Bash parser:** Add parser for Bash code ([2d9f530](https://github.com/stencila/stencila/commit/2d9f53009a9d47de6800832d8b040919d020d664))
* **Binaries:** Add `BinaryInstallation::interact` for interacting with long running processes ([19996fe](https://github.com/stencila/stencila/commit/19996fe348df3c70a45b89191cd79b0c383df270))
* **Binaries:** Allow glob patterns for binary paths; add `r` and `chromium` binary specs ([516d7a6](https://github.com/stencila/stencila/commit/516d7a65e38cdf9f14c5939c3304bd35c6abe377))
* **Binaries:** Expose functions for checking for existing installation ([094714c](https://github.com/stencila/stencila/commit/094714c5d523697f290e7f64bdd53fced4c9e730))
* **Deno kernel:** Add kernel for executing Typescript code ([9d68fa5](https://github.com/stencila/stencila/commit/9d68fa5ec6edd4d9dacaf253569bda4f9c5405c4))
* **Kernels:** Add `KernelSelector` for more precision in selecting kernel to execute in ([5c8b76c](https://github.com/stencila/stencila/commit/5c8b76c310f50bdadfd4cdd63350d14c3ed1fc28)), closes [#1328](https://github.com/stencila/stencila/issues/1328)
* **Kernels:** Integrate microkernels ([6bf692b](https://github.com/stencila/stencila/commit/6bf692b12d753c10c73bffdc2ba4d32956ff8d3a))
* **Kernels:** Support kernel forks ([ba34fa2](https://github.com/stencila/stencila/commit/ba34fa2456977fb5789588ce3c5175a542fe77c0))
* **Microkernels:** Add `MicroKernel`s as a lightweight alternative to `JupyterKernel` ([57f0c90](https://github.com/stencila/stencila/commit/57f0c902c7c3ba93291f9624940d2fc84d70db58))
* **Microkernels:** Add ability to specify which OSes a microkernel can run ([dbafd8e](https://github.com/stencila/stencila/commit/dbafd8e07baaed173fb5c43d6e1b3496b3786f83))
* **Node.js microkernel:** Initial iteration of a Node.js microkernel ([d4c4447](https://github.com/stencila/stencila/commit/d4c44476423e888e293ec13dbe320e2f46e5c988))
* **Python kernel:** Initial iteration of encoding for `numpy`, `pandas` and `matplotlib` values ([925d9ed](https://github.com/stencila/stencila/commit/925d9edeea150d71a0308259e82014346aef7ba3))
* **Python microkernel:** Initial iteration of a Python microkernel ([cada22f](https://github.com/stencila/stencila/commit/cada22f8020165988ca5f4eda52d5d427860b202))
* **R microkernel:** Handle conversion of data frames and plots ([2af6ad0](https://github.com/stencila/stencila/commit/2af6ad0f4d8fd96334e827e2e600f20d6feb77b5))
* **R microkernel:** Initial iteration of a R microkernel ([98325d7](https://github.com/stencila/stencila/commit/98325d7553fa21e9a05dcfea45cab46c94b8e5ab))
* **Rust parser:** Initial iteration of a parser for Rust ([abcf8f3](https://github.com/stencila/stencila/commit/abcf8f3a502fbd44526d93acd4e0229597fd57e5))
* **Zsh microkernel:** Add Zsh microkernel ([f2d2746](https://github.com/stencila/stencila/commit/f2d2746d9dcf88a770a90913d63e98542bc07885))
...
* **dependencies:** update docusaurus monorepo to v2.0.0-beta.9 ([a53b674](https://github.com/stencila/stencila/commit/a53b6740cd0afd0964a7fe004ee9d49cff83dea1))
