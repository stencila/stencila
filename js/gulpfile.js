...
const watch = function () {
  ...
  gulp.watch(['./src/Host.yaml'], ['openapi'])
  gulp.watch(['./src/*.yaml'], ['yamlFunc'])
}
...
const build = gulp.series(clean, gulp.parallel(site, ts, openapi, yamlFunc))
