    ...
    let extra_head = if mode == "doc" {
        ...
        format!(
            r#" <link rel="preconnect" href="https://fonts.googleapis.com">
                ...
                <link href="https://fonts.googleapis.com/css2?family=Lato:wght@400;500;900&family=Inter:slnt,wght@-10..0,100..900&family=Montserrat:wght@400;600&display=swap" rel="stylesheet">
