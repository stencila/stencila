...
pub const MEASUREMENT_SCRIPT: &str = include_str!("scripts/measure.js");
...
pub const TOKENS_SCRIPT: &str = include_str!("scripts/tokens.js");
...
pub const PALETTE_SCRIPT: &str = include_str!("scripts/palette.js");
