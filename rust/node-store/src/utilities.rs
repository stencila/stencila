...
use crate::{automerge::ObjId, ReadCrdt};

/// Get the type property of an object in a store
pub fn get_type<C: ReadCrdt>(crdt: &C, obj_id: &ObjId) -> Result<Option<String>> {
...
pub fn get_node_type<C: ReadCrdt>(crdt: &C, obj_id: &ObjId) -> Result<Option<NodeType>> {
