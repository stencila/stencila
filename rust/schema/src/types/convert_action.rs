...
#[serde_as]
#[derive(Debug, SmartDefault, Clone, PartialEq, Serialize, Deserialize, InspectNode, ProbeNode, StripNode, WalkNode, WriteNode, ReadNode, PatchNode, DomCodec, HtmlCodec, JatsCodec, LatexCodec, MarkdownCodec, TextCodec)]
#[serde(rename_all = "camelCase")]
#[derive(derive_more::Display)]
#[display("ConvertAction")]
pub struct ConvertAction {
    /// The type of this item.
    pub r#type: MustBe!("ConvertAction"),
    ...
    #[html(flatten)]
    #[jats(flatten)]
    pub options: Box<ConvertActionOptions>,
...
#[derive(Debug, SmartDefault, Clone, PartialEq, Serialize, Deserialize, InspectNode, ProbeNode, StripNode, WalkNode, WriteNode, ReadNode, PatchNode, DomCodec, HtmlCodec, JatsCodec, LatexCodec, MarkdownCodec, TextCodec)]
#[serde(rename_all = "camelCase")]
pub struct ConvertActionOptions {
...
impl ConvertAction {
    const NICK: [u8; 3] = *b"cva";
    
    pub fn node_type(&self) -> NodeType {
        NodeType::ConvertAction
    }
