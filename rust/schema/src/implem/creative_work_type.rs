...
impl CreativeWorkVariant {
    ...
    pub fn work_type(&self) -> CreativeWorkType {
        match self {
            ...
            CreativeWorkVariant::Evidence(..) => CreativeWorkType::Evidence,
            CreativeWorkVariant::Figure(..) => CreativeWorkType::Figure,
            CreativeWorkVariant::File(..) => CreativeWorkType::File,
            CreativeWorkVariant::Graph(..) => CreativeWorkType::Graph,
            ...
            CreativeWorkVariant::Protocol(..) => CreativeWorkType::Protocol,
            ...
            CreativeWorkVariant::Question(..) => CreativeWorkType::Question,
            CreativeWorkVariant::Request(..) => CreativeWorkType::Request,
