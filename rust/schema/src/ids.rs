pub const IDS: &[(&str, &str)] = &[
    ...
    ("ExecutionDependency", "https://schema.stenci.la/ExecutionDependency"),
    ("ExecutionDependencyRelation", "https://schema.stenci.la/ExecutionDependencyRelation"),
    ("ExecutionDependent", "https://schema.stenci.la/ExecutionDependent"),
    ("ExecutionDependentRelation", "https://schema.stenci.la/ExecutionDependentRelation"),
    ...
    ("ExecutionTag", "https://schema.stenci.la/ExecutionTag"),
