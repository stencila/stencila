...
pub fn normalize_license(license: &str) -> String {
    match license {
        ...
        "CC BY-NC-ND" | "cc-by-nc-nd" => "https://creativecommons.org/licenses/by-nc-nd/4.0/".to_string(),
        "CC BY-NC" | "cc-by-nc" => "https://creativecommons.org/licenses/by-nc/4.0/".to_string(),
        "CC BY-NC-SA" | "cc-by-nc-sa" => "https://creativecommons.org/licenses/by-nc-sa/4.0/".to_string(),
        ...
        "public domain (CC0)" | "cc0" | "CC0" => "https://creativecommons.org/publicdomain/zero/1.0/".to_string(),
        
        // Software licenses
        "MIT" => "https://opensource.org/licenses/MIT".to_string(),
        "GNU GPLv3" | "GPL-3.0" | "gpl-3.0" => "https://www.gnu.org/licenses/gpl-3.0.html".to_string(),
        "Apache License 2.0" | "Apache-2.0" | "apache-2.0" => "https://www.apache.org/licenses/LICENSE-2.0".to_string(),
...
mod tests {
    ...
    fn test_generic_licenses() {
        assert_eq!(
            normalize_license("other open access"),
            "other open access"
        );
        assert_eq!(
    ...
    fn test_unknown_license() {
        assert_eq!(
            normalize_license("custom-license"),
            "custom-license"
        );
    }
}