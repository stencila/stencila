...
impl Executable for CodeChunk {
    ...
    async fn compile(&mut self, executor: &mut Executor) -> WalkControl {
        ...
        if !matches!(self.id_automatically, Some(false))
            && let (Some(label_type), Some(label)) = (&self.label_type, &self.label)
        ...
        if let Some(overlay) = &self.overlay {
            ...
            if needs_compile {
                ...
                executor.patch(
                    ...
                    [
                        ...
                        set(NodeProperty::OverlayCompilationMessages, messages),
            ...
            executor.patch(
                ...
                [
                    ...
                    none(NodeProperty::OverlayCompilationMessages),
