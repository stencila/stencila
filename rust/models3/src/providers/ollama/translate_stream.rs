...
/// Stateful translator for Ollama Chat Completions SSE events.
#[derive(Debug, Clone)]
pub struct OllamaStreamState(ChatCompletionsStreamState);
...
pub fn translate_sse_stream<'a>(
    ...
    crate::providers::common::chat_completions::translate_sse_stream(
        sse_stream,
        ChatCompletionsStreamState::new("ollama", rate_limit, ERROR_CONFIG),
    )
}
