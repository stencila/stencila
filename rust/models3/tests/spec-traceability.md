...
| 8.x | Provider options end-to-end | SHOULD | `tests/integration/{openai,anthropic,gemini,mistral}.rs` | Covered | 5 tests (env-gated): Anthropic beta_headers, Anthropic auto_cache disabled, Gemini safety settings, OpenAI custom headers, Mistral basic generation |
