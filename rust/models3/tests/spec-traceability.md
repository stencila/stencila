...
| 8.x | Provider options end-to-end | SHOULD | `tests/integration/{openai,anthropic,gemini}.rs` | Covered | 4 tests (env-gated): Anthropic beta_headers, Anthropic auto_cache disabled, Gemini safety settings, OpenAI custom headers |
