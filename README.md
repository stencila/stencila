...
| Format                                                                                        | Encoding | Decoding | Test coverage                                                                                     | Notes                                                                                                                                                       |
| --------------------------------------------------------------------------------------------- | -------- | -------- | ------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [JSON](https://github.com/stencila/stencila/blob/main/docs/reference/formats/json.md)         | 🟢       | 🟢       | ![](https://img.shields.io/endpoint?url=https://shields.stencila.dev/codecov?comp=codec_json)     |                                                                                                                                                             |
| [JSON5](https://github.com/stencila/stencila/blob/main/docs/reference/formats/json5.md)       | 🟢       | 🟢       | ![](https://img.shields.io/endpoint?url=https://shields.stencila.dev/codecov?comp=codec_json5)    |                                                                                                                                                             |
| [YAML](https://github.com/stencila/stencila/blob/main/docs/reference/formats/yaml.md)         | 🟢       | 🟢       | ![](https://img.shields.io/endpoint?url=https://shields.stencila.dev/codecov?comp=codec_yaml)     |                                                                                                                                                             |
| Plain text                                                                                    | 🔶       | -        | ![](https://img.shields.io/endpoint?url=https://shields.stencila.dev/codecov?comp=codec_text)     |                                                                                                                                                             |
| [HTML](https://github.com/stencila/stencila/blob/main/docs/reference/formats/html.md)         | 🚧       | 🧭       | ![](https://img.shields.io/endpoint?url=https://shields.stencila.dev/codecov?comp=codec_html)     |                                                                                                                                                             |
| [JATS](https://github.com/stencila/stencila/blob/main/docs/reference/formats/jats.md)         | 🚧       | 🚧       | ![](https://img.shields.io/endpoint?url=https://shields.stencila.dev/codecov?comp=codec_jats)     | Planned for completion Q4 2023. Port decoding and tests from [`encoda`](https://github.com/stencila/encoda/).                                               |
| [Markdown](https://github.com/stencila/stencila/blob/main/docs/reference/formats/markdown.md) | 🚧       | 🧭       | ![](https://img.shields.io/endpoint?url=https://shields.stencila.dev/codecov?comp=codec_markdown) | Planned Q4 2023 [`v1`](https://github.com/stencila/stencila/tree/v1/rust/codec-md).                                                                         |
...
| Language   | Description                                                     | Status                                                                     | Test coverage                                                                                                                                                 |
| ---------- | --------------------------------------------------------------- | -------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Python     | Types and function bindings for using Stencila from Python      | ⚠️ Alpha published on [PyPI](https://pypi.org/project/stencila/)           | [![](https://img.shields.io/endpoint?url=https://shields.stencila.dev/codecov?comp=sdk_python)](https://app.codecov.io/gh/stencila/stencila/tree/main/python) |
...
| Node.js    | Types and function bindings for using Stencila from Node.js     | ⚠️ Alpha published on [NPM](https://www.npmjs.com/package/@stencila/node)  | [![](https://img.shields.io/endpoint?url=https://shields.stencila.dev/codecov?comp=sdk_node)](https://app.codecov.io/gh/stencila/stencila/tree/main/node)     |
