...
| ---------------- | -------- | -------- | ------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------- |
| JSON             | 🟢       | 🟢       | ![](https://img.shields.io/endpoint?url=https://shields.stencila.dev/codecov?comp=codec_json)     |                                                                                                                                                             |
| JSON5            | 🟢       | 🟢       | ![](https://img.shields.io/endpoint?url=https://shields.stencila.dev/codecov?comp=codec_json5)    |                                                                                                                                                             |
| YAML             | 🟢       | 🟢       | ![](https://img.shields.io/endpoint?url=https://shields.stencila.dev/codecov?comp=codec_yaml)     |                                                                                                                                                             |
| Plain text       | 🔶       | -        | ![](https://img.shields.io/endpoint?url=https://shields.stencila.dev/codecov?comp=codec_text)     |                                                                                                                                                             |
| HTML             | 🚧       | 🧭       | ![](https://img.shields.io/endpoint?url=https://shields.stencila.dev/codecov?comp=codec_html)     |                                                                                                                                                             |
| JATS             | 🚧       | 🚧       | ![](https://img.shields.io/endpoint?url=https://shields.stencila.dev/codecov?comp=codec_jats)     | Planned for completion Q4 2023. Port decoding and tests from [`encoda`](https://github.com/stencila/encoda/).                                               |
| Markdown         | 🚧       | 🧭       | ![](https://img.shields.io/endpoint?url=https://shields.stencila.dev/codecov?comp=codec_markdown) | Planned Q4 2023 [`v1`](https://github.com/stencila/stencila/tree/v1/rust/codec-md).                                                                         |
