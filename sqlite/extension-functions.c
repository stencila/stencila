/*
This file downloaded from http://www.sqlite.org/contrib/download/extension-functions.c?get=25 on 2012-02-03.
Only changes are:
    - this comment block
    - commenting out the line "#define COMPILE_SQLITE_EXTENSIONS_AS_LOADABLE_MODULE 1"
*/
