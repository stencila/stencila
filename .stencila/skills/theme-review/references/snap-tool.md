...
Use `snap` during review to gather visual evidence for findings rather than relying solely on static CSS analysis. You can snap both the `/_specimen` route and the user's own document or site routes.
