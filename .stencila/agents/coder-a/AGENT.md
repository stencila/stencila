---
name: coder-a
description: Coding agent using Anthropic's frontier coding model
keywords:
  - code
  - coding
  - programming
...
when-to-use:
  ...
  - when a coding task needs a capable general-purpose agent using Anthropic's frontier model
when-not-to-use:
