---
name: software-delivery-completer
...
# Medium model with high reasoning suits plan-level verification: the completer
# must carefully read Definition of Done items, cross-reference completed work,
# and make nuanced judgements about what qualifies as minor closeout vs substantial
# unfinished work. High reasoning ensures thorough analysis without needing
# the broad codebase context that would justify a large model.
model-size: medium
