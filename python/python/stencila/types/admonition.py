...
class Admonition(Entity):
    ...
    def __init__(self, admonition_type: AdmonitionType, content: List[Block], id: Optional[str] = None, title: Optional[List[Inline]] = None, is_folded: Optional[bool] = None, authors: Optional[List[Author]] = None):
